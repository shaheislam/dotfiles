-- Python and Rust development enhancements
return {
  -- Replace pyright with basedpyright for better Python LSP
  {
    ...
    opts = {
      servers = {
        ...
        -- Disable pyright if it was configured elsewhere
        pyright = false,
      },
      setup = {
        ruff = function()
      ...
      vim.g.rustaceanvim = {
        ...
        server = {
          on_attach = function(client, bufnr)
            ...
            vim.keymap.set("n", "<leader>rj", function() vim.cmd.RustLsp('joinLines') end, vim.tbl_extend("force", opts, { desc = "Rust Join Lines" }))
            vim.keymap.set("n", "<leader>rs", function() vim.cmd.RustLsp({ 'ssr' }) end, vim.tbl_extend("force", opts, { desc = "Rust Structural Search Replace" }))
            vim.keymap.set("n", "<leader>rg", function() vim.cmd.RustLsp('crateGraph') end, vim.tbl_extend("force", opts, { desc = "Rust Crate Graph" }))
          end,
          default_settings = {
  ...
  -- Disable the default rust-tools in favor of rustaceanvim
      ...
      crates.setup({
        ...
        lsp = {
          ...
          on_attach = function(client, bufnr)
            ...
            vim.keymap.set("n", "<leader>cv", function() crates.show_versions_popup() end, vim.tbl_extend("force", opts, { desc = "Show crate versions" }))
            vim.keymap.set("n", "<leader>cf", function() crates.show_features_popup() end, vim.tbl_extend("force", opts, { desc = "Show crate features" }))
            ...
            vim.keymap.set("n", "<leader>cH", function() crates.open_homepage() end, vim.tbl_extend("force", opts, { desc = "Open crate homepage" }))
            vim.keymap.set("n", "<leader>cR", function() crates.open_repository() end, vim.tbl_extend("force", opts, { desc = "Open crate repository" }))
            vim.keymap.set("n", "<leader>cD", function() crates.open_documentation() end, vim.tbl_extend("force", opts, { desc = "Open crate documentation" }))
            vim.keymap.set("n", "<leader>cC", function() crates.open_crates_io() end, vim.tbl_extend("force", opts, { desc = "Open crates.io" }))
            vim.keymap.set("n", "<leader>cL", function() crates.open_lib_rs() end, vim.tbl_extend("force", opts, { desc = "Open lib.rs" }))
          end,
          actions = true,
          completion = true,
          hover = true,
