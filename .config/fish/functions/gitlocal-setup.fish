...
complete -c gitlocal-setup -l ignore-agents-md -d "Ignore AGENTS.md as local-only guidance"
complete -c gitlocal-setup -l no-ignore-agents-md -d "Keep AGENTS.md trackable"
