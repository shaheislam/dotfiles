...
**Model**: Opus 4.6 default, `CLAUDE_CODE_EFFORT_LEVEL=max` (session-scoped, Opus only), `/effort max` belt-and-suspenders in gwt-rename-session.sh, `/model opusplan` for plan→execute split.
