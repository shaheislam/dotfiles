---
name: dream
description: Consolidate AI agent memory through a 4-phase process (Orient, Gather Signal, Consolidate, Prune & Index). Mimics natural sleep-based memory consolidation. Auto-triggers every 24hrs via Stop hook.
---
