...
```bash
agent-browser auth login --name github --url https://github.com/login
# Follow prompts to login. Credentials stored securely in encrypted vault.

# Use stored credentials
agent-browser auth use github open https://github.com/settings/profile
```
