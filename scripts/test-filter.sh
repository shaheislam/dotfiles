...
test_opencode() {
    ...
    run_test "sync-agent-commands-personal script exists" "[ -x '$DOTFILES_ROOT/scripts/sync-agent-commands-personal.sh' ]"
    run_test "sync-agent-commands-personal script syntax valid" "bash -n '$DOTFILES_ROOT/scripts/sync-agent-commands-personal.sh'"
    run_test "OpenCode commands mirror Claude canonical" "bash '$DOTFILES_ROOT/scripts/sync-agent-commands-personal.sh' --check >/dev/null"
