...
test_opencode() {
    ...
    run_test "OpenCode harness owns window color" "grep -q 'tmux-agent-prompt.sh' '$DOTFILES_ROOT/.config/opencode/plugin/harness-compat.ts' && grep -q 'tmux-agent-stop.sh' '$DOTFILES_ROOT/.config/opencode/plugin/harness-compat.ts'"
    ...
    run_test "OpenCode tmux launcher avoids pane scraping" "! grep -q 'capture-pane\|esc interrupt\|ctrl\[+\]p commands' '$DOTFILES_ROOT/scripts/opencode/tmux-open.sh'"
    ...
    run_test "OpenCode tmux launcher does not poll status color" "! grep -q 'set_window_style\|sync_window_style\|OPENCODE_TMUX_STATUS_INTERVAL' '$DOTFILES_ROOT/scripts/opencode/tmux-open.sh'"
    ...
    run_test "OpenCode tmux idle status is yellow" "grep -q 'tmux-agent-stop.sh' '$DOTFILES_ROOT/.config/opencode/plugin/harness-compat.ts' && grep -q '#\[fg=#e0af68\]' '$DOTFILES_ROOT/scripts/tmux/hooks/tmux-agent-stop.sh'"
