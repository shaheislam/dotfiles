...
test_opencode() {
    ...
    run_test "OpenCode OpenAI rotate preflights prompts" "grep -q 'preflightRotate' '$DOTFILES_ROOT/.config/opencode/plugin/openai-rotate.ts'"
    ...
    run_test "OpenCode live rotation smoke script exists" "[ -f '$DOTFILES_ROOT/scripts/opencode/test-live-rotation.sh' ]"
    run_test "OpenCode live rotation smoke script executable" "[ -x '$DOTFILES_ROOT/scripts/opencode/test-live-rotation.sh' ]"
    run_test "OpenCode live rotation smoke syntax valid" "bash -n '$DOTFILES_ROOT/scripts/opencode/test-live-rotation.sh'"
