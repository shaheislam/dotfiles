...
test_opencode() {
    ...
    run_test "OpenCode generated LaunchAgent ignored by stow" "grep -Fq 'Library/LaunchAgents/com\.dotfiles\.opencode-serve\.plist' '$DOTFILES_ROOT/.stow-local-ignore'"
