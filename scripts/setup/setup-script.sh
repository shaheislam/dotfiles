...
echo "- Clipboard manager: CopyQ (with Karabiner-Elements Cmd+Shift+V shortcut)"
...
echo "4. Grant CopyQ Accessibility access: System Settings → Privacy & Security → Accessibility → Enable CopyQ"
echo "   Then press Cmd+Shift+V to open clipboard history (requires Karabiner-Elements running)"
