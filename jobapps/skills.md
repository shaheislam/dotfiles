...
- Fish shell
- Nix (package management, LSP isolation)
...
- Implemented the Grafana Labs stack of Loki, Mimir & Tempo, performing load testing across the components to size resources appropriately leveraging k6s [Tags: Grafana, Loki, Mimir, Tempo, k6, Load Testing, Observability] [ALWAYS_DFE]
